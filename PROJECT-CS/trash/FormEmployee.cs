    ...
    public partial class FormEmployee : Form
    {
        ...
        private void btnempsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sql = "INSERT INTO `employee` (`emp_code`, `emp_fname`, `emp_lname`, `emp_nname`"
        ...
        private void txtcode_TextChanged(object sender, EventArgs e)
        {
            ...
            if (config.dt.Rows.Count > 0)
            {
                ...
                txtmname.Text = config.dt.Rows[0].Field<string>("emp_nname").ToString();
                ...
                if (config.dt.Rows[0].Field<string>("emp_sex").ToString() == "ชาย")
                {
...

        {
            ...
            else
            {
                ...
                + "', `emp_lname`='" + txtlname.Text + "', `emp_nname`='" + txtmname.Text
        ...
        //คำสั่ง ค้นหาข้อมูล โดยinput ผ่าน textcode
        private void list_Employee()
        {
            sql = "SELECT `emp_code` AS 'CODE',CONCAT( `emp_fname`,' ', `emp_lname`,' ') AS 'NAME'"
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("ทำการลบข้อมูลพนักงานเรียบร้อยแล้ว.", "Delete", MessageBoxButtons.OK, MessageBoxIcon.Information);
            btnempnew_Click(sender, e);
        }
        //ทำการสลับไปหน้ากรอกข้อมูล 
